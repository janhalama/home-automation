...
void test_nx_json_parse() {
    ...
    assert(boolean_true->u.num.value.u_value == 1);
    ...
    assert(boolean_false->u.num.value.u_value == 0);
    ...
    assert(value->u.num.value.u_value == 123);
    ...
    assert(strcmp(nested_key->u.text_value, "nested_value") == 0);
    ...
    for (unsigned long i = 0; i < 5; i++) {
        ...
        assert(item->u.num.value.u_value == i + 1);
    }
    ...
    assert(strcmp(mixed_string->u.text_value, "string") == 0);
    ...
    assert(strcmp(mixed_key->u.text_value, "value") == 0);
